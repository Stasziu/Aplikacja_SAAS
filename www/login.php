...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        $username_err = "Wprowadź swoją nazwę użytkownika.";
    } else{
...
<body>
    <div class="wrapper">
        ...
        <p>Proszę wprowadź swoje dane do zalogowania.</p>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Nie posiadasz konta? <a href="register.php">Utwórz je teraz</a>.</p>
        </form>
    </div>
</body>
</html>