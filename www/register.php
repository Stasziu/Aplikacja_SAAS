...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $username_err = "Nazwa użytkownika może zawierać tylko litery cyfry oraz podkreślnik.";
    } else{
    ...
    if(empty(trim($_POST["confirm_password"]))){
        ...
        if(empty($password_err) && ($password != $confirm_password)){
            $confirm_password_err = "Wprowadzone hasła do siebie nie pasują.";
        }
    }
...
<body>
    <div class="wrapper">
        ...
        <p>Uzupełnij formularz, aby utworzyć swoje konto.</p>
